...
export default function Home() {
  return (
    <main className='flex justify-center items-center w-full pt-40 md:pt-0'>
      {/* Icon bar */}
      ...
      {/* Email */}
      <div className="absolute md:bottom-8 md:right-8 md:top-auto top-6 right-8 font-[family-name:var(--font-ocr)] text-xl md:text-3xl">
        <a 
